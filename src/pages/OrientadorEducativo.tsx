...
// Styles
import "../styles/OrientadorEducativo.css"
...
export const OrientadorEducativo = (props: propsType) => {
    const {
        apiBase,
        user,
        pass,
    ...
    const apiUrlDeleteNewMeeting = apiUrlBase + "/delete/new/meetings";
    ...
    const isNewMeetingOpen = () => {
        ...
        fetch(url, {
            ...
            .then((data) => {
                if (!data) {
                    url = new Request(apiUrlDeleteNewMeeting);
